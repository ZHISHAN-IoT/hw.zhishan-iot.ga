...
// init controller
    ...
    if (!isiPad) {
        ...
        var stickyOptions = {duration: 1600, offset: 140};
        var fadeOptions = {duration: 200, offset: 100};
        var fadeValueTextOptions = {duration: 300, offset: 220};
        var moveLeftOptions = {duration: 300, offset: 100};
        var fadeOutOptions = {duration: 100, offset: 100};
        var lastClose = {duration: 100, offset: 100};
        ...
        var fade = new ScrollScene({duration: 400, offset: 100})
                .addTo(controller)
                .triggerHook("onCenter")
                .triggerElement('.trigger-fade-circle')
                .setTween(TweenMax.from(circle1, 1, {autoAlpha: 0}));

        var scaleBig = new ScrollScene(fadeOptions)
                .addTo(controller)
                .triggerHook("onCenter")
                .triggerElement('.trigger-fade-circle')
                .setTween(TweenMax.to(circle1, 1, {scale: 1.7}));
        ...
        var fade = new ScrollScene(fadeOptions)
                ...
                .triggerHook("onCenter")
                .triggerElement('.trigger-fade-circle')
                .setTween(TweenMax.from(circle2, 1, {autoAlpha: 0}));

        var scaleBig = new ScrollScene(fadeOptions)
                .addTo(controller)
                .triggerHook("onCenter")
                .triggerElement('.trigger-fade-circle')
                .setTween(TweenMax.to(circle2, 1, {scale: 1.7}));
        ...
        var fade = new ScrollScene(fadeOptions)
                ...
                .triggerHook("onCenter")
                .triggerElement('.trigger-fade-circle')
                .setTween(TweenMax.from(circle3, 1, {autoAlpha: 0}));

        var scaleBig = new ScrollScene(fadeOptions)
                .addTo(controller)
                .triggerHook("onCenter")
                .triggerElement('.trigger-fade-circle')
                .setTween(TweenMax.to(circle3, 1, {scale: 1.7}));
        ...
        var fadeText = new ScrollScene(fadeValueTextOptions)
                ...
                .triggerHook("onCenter")
                .triggerElement('.trigger-fade-circle')
                .setTween(TweenMax.from(valueText, 1, {autoAlpha: 0}));
        ...
        var scaleSmall = new ScrollScene(fadeOptions)
                ...
                .setTween(TweenMax.to(circle1, 1, {scale: 1}));

        var scaleSmall = new ScrollScene(fadeOptions)
                .addTo(controller)
                .triggerHook("onCenter")
                .triggerElement('.trigger-scale-small')
                .setTween(TweenMax.to(circle2, 1, {scale: 1}));

        var scaleSmall = new ScrollScene(fadeOptions)
                .addTo(controller)
                .triggerHook("onCenter")
                .triggerElement('.trigger-scale-small')
                .setTween(TweenMax.to(circle3, 1, {scale: 1}));
        ...
        var moveText = new ScrollScene(fadeValueTextOptions)
                ...
                .triggerHook("onCenter")
                .triggerElement('.trigger-scale-small')
                .setTween(TweenMax.to(valueText, 2, {top: -70}));

        var moveRed = new ScrollScene(moveLeftOptions)
                .addTo(controller)
                .triggerElement('.trigger-scale-small')
                .setTween(TweenMax.from(circle2, 0.1, {css: {marginLeft: -140}}));

        var moveYellow = new ScrollScene(moveLeftOptions)
                .addTo(controller)
                .triggerElement('.trigger-scale-small')
                .setTween(TweenMax.from(circle3, 0.1, {css: {marginLeft: -140}}));


        var fadeDisplayText = new ScrollScene({duration: 200, offset: 100})
                .addTo(controller)
                .triggerHook("onCenter")
                .triggerElement('.trigger-text-arrow')
                .setTween(TweenMax.to(displayText, 1, {css: {opacity: 1}}));


        var hideText = new ScrollScene({duration: 150, offset: 200})
                .addTo(controller)
                .triggerHook("onCenter")
                .triggerElement('.trigger-text-arrow')
                .setTween(TweenMax.from(arrows, 1, {autoAlpha: 0}));


        var fadeDisplayText = new ScrollScene({duration: 150, offset: 300})
                .addTo(controller)
                .triggerHook("onCenter")
                .triggerElement('.trigger-text-arrow')
                .setTween(TweenMax.to(descText, 1, {css: {opacity: 1}}));
...
//news wall
    ...
    if (page == 'logo') {
        ...
        $(window).resize(function () {
            if ($("#logowall").width() < 1024) {
                $("#logowall").masonry('option', {columnWidth: 240});
            } else if ($("#logowall").width() < 1120) {
                $("#logowall").masonry('option', {columnWidth: 256});
            } else if ($("#logowall").width() < 1280) {
                $("#logowall").masonry('option', {columnWidth: 280});
            } else {
                $("#logowall").masonry('option', {columnWidth: 320});
            }
        });
...
// ANIMATION SUPPORT CHECK
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                response.forEach(function (entry) {
                    ...
                    if (entry.type == 0) {
                        html += '<article class="cell company" href="' + baseURL + lang + '/news/detail/' + entry.uri + '"><div class="img-cont"><a class="desaturate" href="' + baseURL + lang + '/news/detail/' + entry.uri + '"><img src="' + baseURL + 'attachment/news/' + entry.id + '/' + entry.file_name + '"></a></div><div class="content"><div class="title">' + entry.news_date + '<span>news</span></div><div class="red-line-40"></div><p>' + entry.news_subject + '</p></div></article>';
                    }


                    if (entry.type == 1) {
                        if (entry.file_name != null) {
                            html += '<article class="cell company team" href="' + entry.link + '"><div class="img-cont"><a class="desaturate" href="' + entry.link + '"><img src="' + baseURL + 'attachment/news/' + entry.id + '/' + entry.file_name + '"></a></div><div class="content"><div class="title">' + entry.news_date + '<span>team news</span></div><div class="red-line-40"></div><p>' + entry.news_subject + '</p></div></article>';
                        } else {
                            html += '<article class="cell company news-without-images team" href="' + entry.link + '"><div class="content"><div class="title">' + entry.news_date + '<span>team news</span></div><div class="red-line-40"></div><p>' + entry.news_subject + '</p></div></article>';
                        }
                    }

                    if (entry.type == 2) {
                        if (entry.file_name != null) {
                            html += '<article class="cell company noteworthy" href="' + entry.link + '"><div class="img-cont"><a class="desaturate" href="' + entry.link + '"><img src="' + baseURL + 'attachment/news/' + entry.id + '/' + entry.file_name + '"></a></div><div class="content"><div class="title">' + entry.news_date + '<span>noteworthy</span></div><div class="red-line-40"></div><p>' + entry.news_subject + '</p></div></article>';
                        } else {
                            html += '<article class="cell company noteworthy news-without-images" href="' + entry.link + '"><div class="content"><div class="title">' + entry.news_date + '<span>noteworthy</span></div><div class="red-line-40"></div><p>' + entry.news_subject + '</p></div></article>';
                        }
                    }
    ...
    $('.step-icon').each(function (i) {
        ...
        if ($icon.hasClass('active')) {
            ...
            /*
             ...
             alert('123');
             $icon.hover(function () {
             $icon.children('.static').fadeOut(1, function() {
             $icon.children('.hover').fadeIn(1);
             });
             }, function () {
             $icon.children('.hover').fadeOut(1, function() {
             $icon.children('.static').fadeIn(1);
             });
             });
             }*/
        }
    ...
    $('.header-waypoint').each(function (i) {
        ...
        $el.waypoint(function (direction) {
            ...
            if (direction === 'down' && section != '404') {
                ...
                // $('.navbar-header, .navbar-static-top').animate({
                //     height: "50px",
                // }, 380, function () {
                // });
    ...
    $('#case-study-meth').waypoint(function (direction) {
        ...
        if (direction == 'down') {
            ...
            // $('.sub-navbar-header').delay(300).fadeIn();
            // $('.sub-menu').delay(300).fadeIn();
            // $('.nav').fadeOut();

        } else if (direction === 'up') {

            // $('.sub-navbar-header').delay(300).fadeOut();
            // $('.sub-menu').fadeOut();
            // $('.nav').delay(300).fadeIn();
        }
...
//            console.log($this.data("filter"));
    ...
    $('.round-arrow').click(function () {
        ...
        $('.youtube-loader').html('<iframe width="560" height="315" src="' + target + '" frameborder="0" allowfullscreen></iframe>');
...
if (page == 'news') {
    ...
    /*
     var ewall = new freewall("#newswall");
     ewall.reset({
     selector: '.cell',
     animate: true,
     cellW: 150,
    ...
    // $('.cell').hover(
    //         function () {
    //             if ($(this).children('.img-cont').children().hasClass('desaturate')) {
    //                 $(this).children('.img-cont').children().removeClass('desaturate');
    //             }
    //         }, function () {
    //     $(this).children('.img-cont').children().addClass('desaturate');
    // }
    // );
}
...
//         $('.page-brand-building-agency .how-approach').height((Math.ceil(($('.how-approach img').width()) + $(window).width())) * 4);
//         $('.page-brand-building-agency .how-approach').css('background-position', '0px ' + ($(window).height() * 0.12) + 'px');
//     } else {
//         $('.page-brand-building-agency .how-approach').height((Math.ceil(($('.how-approach img').width()) + $(window).width())) * 3);
//     }
// }

// if ($('.page-brand-building-agency').length > 0) {
//     $(window).on('scroll', function() {
//       var st  = $(window).scrollTop(),
//           top = $('.how-approach').offset().top,
//           bh  = $('.how-approach').height(),
//           d   = (top - st) / $(window).height(),
//           w   = $('.how-approach img').width();
...
//         //   yval = Math.ceil(Math.abs(st)) - $(window).height() + 'px';
//         // }
//         if (navigator.userAgent.indexOf('iPhone') != -1) {
//             yval = Math.ceil(Math.abs(st) + ($(window).height() * 0.2)) + 'px';
//             $('body').css('background-position', (d * w ) + ($(window).width() * 0.15) + 'px ' + yval);
//         } else {
//             $('body').css('background-position', (d * w / 2) + 'px ' + yval);
//         }
//         // $('body').css('background-position', '-' + ((Math.abs(ttop) / bh) * w  * 1.5) + 'px ' + yval);
//       }
//     });
// }
